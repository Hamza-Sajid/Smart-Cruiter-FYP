...
function InterviewingCandidateDetails() {
  ...
  const handleSavingDateAndTime = () => {
    ...
    const options = {
      url: "https://smart-cruiter-fyp-production.up.railway.app/details/active/interviewing/details/dateandtime",
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json;charset=UTF-8",
                    ...
                    <div className="modal-action block m-auto text-center mt-6">
                      <label
                        ...
                        onClick={() => {
                          // axios POST request
                          const options = {
                            url: "https://smart-cruiter-fyp-production.up.railway.app/details/active/interviewing/details/sendInterviewEmail",
                            method: "POST",
                            headers: {
                              Accept: "application/json",
                              "Content-Type": "application/json;charset=UTF-8",
